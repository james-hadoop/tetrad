 ...
 */
public final class LinearSemImEditor extends JPanel implements LayoutEditable, DoNotScroll {
     ...
     */
    public LinearSemImEditor(LinearSemImWrapper semImWrapper) {
     ...
     * Constructs a new SemImEditor from the given OldSemEstimateAdapter.
     */
    public LinearSemImEditor(SemEstimatorWrapper semEstWrapper) {
        this(new LinearSemImWrapper(semEstWrapper.getSemEstimator().getEstimatedSem()));
    }

    /**
     * Constructs an editor for the given SemIm.
     */
    public LinearSemImEditor(final LinearSemImWrapper wrapper, final String graphicalEditorTitle,
...
//            comp.setMaximumSize(comp.getPreferredSize());
    ...
    public void displaySemIm(LinearSemIm updatedSem, int tabSelectionIndex, int matrixSelection) {
    ...
    private LinearSemImWrapper wrapper;
    ...
    private class OneEditor extends JPanel implements LayoutEditable {
        ...
        private final LinearSemImWrapper semImWrapper;

        /**
         * The graphical editor for the SemIm.
         */
        private LinearSemImGraphicalEditor semImGraphicalEditor;

        /**
         * Edits the parameters in a simple list.
         */
        private LinearSemImTabularEditor semImTabularEditor;
        ...
        public OneEditor(LinearSemImWrapper wrapper, String graphicalEditorTitle, String tabularEditorTitle,
...
//        file.add(new SaveScreenshot(this, true, "Save Screenshot..."));
            ...
            saveSemAsXml.addActionListener(e -> {
                try {
                    ...
                    LinearSemIm bayesIm = (LinearSemIm) oneEditorPanel.getSemIm();
...
//        semImGraphicalEditor.getWorkbench().setGraph(_graph);
        ...
        private void checkForUnmeasuredLatents(ILinearSemIm semIm) {
         ...
         */
        public void displaySemIm(LinearSemIm semIm, int tabSelectionIndex,
                                 int matrixSelection) {
            if (semIm == null) {
            ...
            LinearSemImEditor.this.wrapper = new LinearSemImWrapper(semIm);
        ...
        private ILinearSemIm getSemIm() {
            return semImWrapper.getSemIm();
        }

        private LinearSemImGraphicalEditor graphicalEditor() {
            if (this.semImGraphicalEditor == null) {
                this.semImGraphicalEditor = new LinearSemImGraphicalEditor(wrapper,
                        this, this.maxFreeParamsForStatistics);
                this.semImGraphicalEditor.addPropertyChangeListener((evt) -> {
                    LinearSemImEditor.this.firePropertyChange(evt.getPropertyName(), null, null);
                });
            }
            return this.semImGraphicalEditor;
        }

        private LinearSemImTabularEditor tabularEditor() {
            if (this.semImTabularEditor == null) {
                this.semImTabularEditor = new LinearSemImTabularEditor(wrapper, this,
     ...
     */
    final class LinearSemImGraphicalEditor extends JPanel {
        ...
        private final LinearSemImWrapper wrapper;
         ...
         */
        private LinearSemImEditor.OneEditor editor = null;
         ...
         */
        public LinearSemImGraphicalEditor(LinearSemImWrapper semImWrapper, LinearSemImEditor.OneEditor editor,
...
//                    resetLabels();
        ...
        private void beginEdgeEdit(final Edge edge) {
            ...
            field.addAncestorListener(new AncestorListener() {
                ...
                public void ancestorAdded(AncestorEvent ancestorEvent) {
                    ...
                    if (ancestor instanceof JDialog) {
                        LinearSemImGraphicalEditor.this.dialog = ancestor;
                    }
            ...
            field.addActionListener((e) -> {
                if (LinearSemImGraphicalEditor.this.dialog != null) {
                    LinearSemImGraphicalEditor.this.dialog.setVisible(false);
                }
            });
        ...
        private void setEdgeValue(Edge edge, String text) {
            try {
                ...
                if (editor.isEditCovariancesAsCorrelations()
                    ...
                    LinearSemImGraphicalEditor.this.firePropertyChange("modelChanged", null, null);
                } else if (!editor.isEditCovariancesAsCorrelations()
                        && parameter.getType() == ParamType.COVAR) {
                    semIm().setParamValue(parameter, d);
                    LinearSemImGraphicalEditor.this.firePropertyChange("modelChanged", null, null);
...
//        workbench().setAllowNodeDragging(false);
        ...
        final class EdgeMouseListener extends MouseAdapter {
            ...
            private final LinearSemImGraphicalEditor editor;

            public EdgeMouseListener(Edge edge, LinearSemImGraphicalEditor editor) {
                this.edge = edge;
                this.editor = editor;
            }
            ...
            private LinearSemImGraphicalEditor getEditor() {
                return editor;
            }
        ...
        final class NodeMouseListener extends MouseAdapter {
            ...
            public NodeMouseListener(Node node, LinearSemImGraphicalEditor editor) {
                this.node = node;
                this.editor = editor;
            }
        ...
        final class EdgeActionListener implements ActionListener {
            ...
            public EdgeActionListener(LinearSemImGraphicalEditor editor, Edge edge) {
                this.editor = editor;
                this.edge = edge;
            }
        ...
        final class NodeActionListener implements ActionListener {
            ...
            public NodeActionListener(LinearSemImGraphicalEditor editor, Node node) {
                this.editor = editor;
                this.node = node;
            }
     ...
     */
    final class LinearSemImTabularEditor extends JPanel {
        ...
        public LinearSemImTabularEditor(LinearSemImWrapper wrapper, LinearSemImEditor.OneEditor editor,
                                        int maxFreeParamsForStatistics) {
            this.wrapper = wrapper;
...
//        setBorder(new TitledBorder("Click parameter values to edit"));
            ...
            tableModel.addTableModelListener((e) -> {
                LinearSemImTabularEditor.this.firePropertyChange("modelChanged", null, null);
            });
    ...
    final class ParamTableModel extends AbstractTableModel {
        ...
        public ParamTableModel(LinearSemImWrapper wrapper, LinearSemImEditor.OneEditor editor,
                               int maxFreeParamsForStatistics) {
            this.wrapper = wrapper;
...
//                    }
    ...
    class ImpliedMatricesPanel extends JPanel {
        ...
        public ImpliedMatricesPanel(LinearSemImWrapper wrapper, int matrixSelection) {
            this.wrapper = wrapper;
    ...
    final class ImpliedCovTable extends AbstractTableModel {
         ...
         */
        public ImpliedCovTable(LinearSemImWrapper wrapper, boolean measured,
    ...
    final class ModelStatisticsPanel extends JTextArea {
        ...
        public ModelStatisticsPanel(LinearSemImWrapper wrapper) {
            this.wrapper = wrapper;
            reset();
        ...
        private void reset() {
            ...
            List<Node> variables = linearSemPm.getVariableNodes();
