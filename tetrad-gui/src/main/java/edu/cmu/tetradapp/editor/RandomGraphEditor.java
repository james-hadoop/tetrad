...
class RandomGraphEditor extends JPanel {
    ...
    private final IntTextField avgDegreeField;
...
//    private final JRadioButton chooseFixed;
    ...
    public RandomGraphEditor(Graph oldGraph, boolean cyclicAllowed, Parameters parameters) {
        ...
        avgDegreeField = new IntTextField(getAvgDegree(), 4);
...
//        chooseFixed.setSelected(isChooseFixed());
        ...
        avgDegreeField.setFilter(new IntTextField.Filter() {
            public int filter(int value, int oldValue) {
...
//    }
    ...
    public int getAvgDegree() {
        return parameters.getInt(Params.AVG_DEGREE);
    }


    private void setAvgDegree(int avgDegree) {
        parameters.set(Params.AVG_DEGREE, avgDegree);
    }

    public int getMaxDegree() {
        return parameters.getInt("maxDegree", 100);
    }
