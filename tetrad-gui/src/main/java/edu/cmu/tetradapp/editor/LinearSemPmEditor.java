...
import edu.cmu.tetradapp.model.LinearSemPmWrapper;
 ...
 */
public final class LinearSemPmEditor extends JPanel implements DelegatesEditing,
        LayoutEditable {

    private final LinearSemPmWrapper semPmWrapper;

    /**
     * The graphical editor for the SemPm.
     */
    private LinearSemPmGraphicalEditor graphicalEditor;
     ...
     */
    public LinearSemPmEditor(LinearSemPmWrapper wrapper) {
...
//        getSemGraph().setShowErrorTerms(false);
    ...
    //========================PRIVATE METHODS===========================//
    private LinearSemPm getSemPm() {
        return semPmWrapper.getSemPms().get(semPmWrapper.getModelIndex());
    }

    private LinearSemPmGraphicalEditor graphicalEditor() {
        if (this.graphicalEditor == null) {
            this.graphicalEditor = new LinearSemPmGraphicalEditor(semPmWrapper);
 ...
 */
class LinearSemPmGraphicalEditor extends JPanel {
     ...
     */
    public LinearSemPmGraphicalEditor(final LinearSemPmWrapper wrapper) {
        this.semPmWrapper = wrapper;
        setLayout(new BorderLayout());
    ...
    private final static class EdgeMouseListener extends MouseAdapter {
        ...
        private final LinearSemPmGraphicalEditor editor;

        public EdgeMouseListener(Edge edge, LinearSemPmGraphicalEditor editor) {
            this.edge = edge;
            this.editor = editor;
        }
        ...
        private LinearSemPmGraphicalEditor getEditor() {
            return editor;
        }
    ...
    private final static class NodeMouseListener extends MouseAdapter {
        ...
        public NodeMouseListener(Node node, LinearSemPmGraphicalEditor editor) {
            this.node = node;
            this.editor = editor;
        }
    ...
    private static final class ParameterEditor extends JPanel {
        ...
        public ParameterEditor(Parameter parameter, LinearSemPm linearSemPm) {
            if (parameter == null) {
