 ...
 */
public final class StandardizedLinearSemImEditor extends JPanel implements LayoutEditable {
     ...
     */
    public StandardizedLinearSemImEditor(final StandardizedSemImWrapper wrapper) {
        StandardizedLinearSemIm semIm = wrapper.getStandardizedSemIm();
...
class StandardizedSemImImpliedMatricesPanel extends JPanel {
    ...
    public StandardizedSemImImpliedMatricesPanel(StandardizedLinearSemIm semIm, int matrixSelection) {
        this.semIm = semIm;
