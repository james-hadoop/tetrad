...
public class TestLinearSemIm {
    ...
    public void test3() {
        ...
        SemEstimator estimator2 = new SemEstimator(covMatrix, linearSemPm);
        estimator2.estimate();
        estimator2.getEstimatedSem();

        SemEstimator estimator3 = new SemEstimator(covMatrix, linearSemPm);
        estimator3.estimate();
        estimator3.getEstimatedSem();

        LinearSemPm linearSemPm4 = new LinearSemPm(graph);
        SemEstimator estimator4 = new SemEstimator(covMatrix, linearSemPm4);
        estimator4.estimate();
        estimator4.getEstimatedSem();

        LinearSemPm linearSemPm5 = new LinearSemPm(graph);
        SemEstimator estimator5 = new SemEstimator(covMatrix, linearSemPm5);
        estimator5.estimate();
    ...
    public void testIntercepts() {
        ...
        Graph randomGraph = new Dag(GraphUtils.randomGraph(nodes, 0, 8, 30, 15, 15, false));
        LinearSemPm linearSemPm = new LinearSemPm(randomGraph);
        LinearSemIm semIm = new LinearSemIm(linearSemPm);
...
//        d1.assign(e, PlusMult.plusMult(1));
    ...
    public void test8() {
        ...
        LinearSemPm linearSemPm = new LinearSemPm(g);
        Parameters params = new Parameters();
        LinearSemIm semIm = new LinearSemIm(linearSemPm, params);

        LinearSemIm modified = modifySemImStandardizedInterventionOnTargetParents(semIm, x4);

        modified.simulateData(1000, false);

    }

    public static LinearSemIm modifySemImStandardizedInterventionOnTargetParents(LinearSemIm semIm, Node
            target) {
        LinearSemIm modifiedSemIm = new LinearSemIm(semIm);
        ...
        LinearSemIm modifiedAndUpdatedSemIm = new
                LinearSemIm(semUpdater.getUpdatedSemIm());
