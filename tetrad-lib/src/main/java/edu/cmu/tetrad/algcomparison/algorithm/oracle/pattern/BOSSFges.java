...
@Bootstrapping
@Experimental
public class BOSSFges implements Algorithm, HasKnowledge, UsesScoreWrapper {
...
//    private Algorithm algorithm;
    ...
    public BOSSFges(ScoreWrapper score) {
    ...
    public Graph search(DataModel dataSet, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            BestOrderScoreSearch search = new BestOrderScoreSearch(new FastForwardFges(scorer));
