...
@TimeSeries
@Bootstrapping
public class TsGfci implements Algorithm, TakesInitialGraph, TakesIndependenceWrapper, UsesScoreWrapper {
...
//        }
        ...
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            edu.cmu.tetrad.search.TsGFci search = new edu.cmu.tetrad.search.TsGFci(test.getTest(dataSet, parameters, trueGraph),
