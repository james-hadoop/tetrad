...
@Bootstrapping
public class QuickGASP implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper {
    ...
    public QuickGASP(ScoreWrapper score, IndependenceWrapper test) {
        this.score = score;
        this.test = test;
    }
    ...
    public Graph search(DataModel dataSet, Parameters parameters, Graph trueGraph) {
        ...
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            gsp.setMethod(Boss.Method.QUICK_GASP);
            ...
            QuickGASP algorithm = new QuickGASP(score, test);
    ...
    return "QuickGASP (Quick Greedy, Adjusted, Sparsest Permutation) using " + test.getDescription()
