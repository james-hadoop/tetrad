...
import edu.cmu.tetrad.search.Grasp2;
...
@Bootstrapping
public class GRaSP2 implements Algorithm, UsesScoreWrapper, TakesIndependenceWrapper {
    ...
    public GRaSP2(ScoreWrapper score, IndependenceWrapper test) {
        this.score = score;
        this.test = test;
    }
    ...
    public Graph search(DataModel dataSet, Parameters parameters, Graph trueGraph) {
        ...
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            Grasp2 grasp = new Grasp2(test, score);
            ...
            grasp.setUseVermaPearl(parameters.getBoolean(Params.GRASP_USE_VERMA_PEARL));
            ...
            GRaSP2 algorithm = new GRaSP2(score, test);
