...
@Bootstrapping
public class BOSSGlobal implements Algorithm, HasKnowledge, UsesScoreWrapper {
...
//    private Algorithm algorithm;
    ...
    public BOSSGlobal(ScoreWrapper score) {
    ...
    public Graph search(DataModel dataSet, Parameters parameters) {
        if (parameters.getInt(Params.NUMBER_RESAMPLING) < 1) {
            ...
            BestOrderScoreSearch search = new BestOrderScoreSearch(new FastForwardGlobalScore(scorer));
...
//            return graph;
            ...
            BOSSGlobal fges = new BOSSGlobal();
