 ...
 */
public final class ConditionalCorrelationLinear {
     ...
     * Basis
     */
    private Basis basis = Basis.Cosine;
     ...
     */
    public ConditionalCorrelationLinear(DataSet dataSet, double alpha) {
    ...
    public double isIndependent(Node x, Node y, List<Node> z) {
        double[] rx = regression.regress(x, z).getResiduals().toArray();
        double[] ry = regression.regress(y, z).getResiduals().toArray();

        double score = independent(rx, ry, z);
        this.score = score;
     ...
     * accessed separately.
     */
    private double independent(double[] x, double[] y, List<Node> z) {
...
//
    ...
    private double nonparametricFisherZ(double[] _x, double[] _y, List<Node> zz) {
