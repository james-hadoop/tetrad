 ...
 */
public final class FgesRequired implements GraphSearch, GraphScorer {

    public Graph getRequiredGraph() {
        return requiredGraph;
    }

    public void setRequiredGraph(Graph requiredGraph) {
        this.requiredGraph = requiredGraph;
    }
    ...
    private Graph requiredGraph = null;
     ...
     */
    public FgesRequired(Score score) {
        if (score == null) {
...
//        meekOrientRestricted(getVariables(), getKnowledge());
    ...
    private boolean noEdgeRequired(Node x, Node y) {
        return !requiredGraph.isParentOf(x, y) && !requiredGraph.isParentOf(y, x);// && getKnowledge().noEdgeRequired(x.getName(), y.getName());
    }
...
//        }
    ...
    private void addRequiredEdges(Graph graph) {
        ...
        for (Edge edge : requiredGraph.getEdges()) {
            graph.addEdge(edge);
        }
