...
//        Fas fas = new Fas(graph, getIndependenceTest());
        ...
        orientCollidersUsingSepsetsCpdag(sepset, getKnowledge(), graph);
...
//        rules.setKnowledge(knowledge);
        ...
        this.logger.log("info", "Finishing PC Cpdag_of_the_true_DAG Algorithm.");
        this.logger.flush();
...
//                }
     ...
     * bidirected edge.
     */
    public void orientCollidersUsingSepsetsCpdag(SepsetMap set,
        ...
        for (Node a : nodes) {
            ...
            while ((combination = cg.next()) != null) {
                ...
                if (sepset != null && !sepset.contains(a) &&
                        isArrowpointAllowedCpdag(b, a, knowledge, graph) &&
                        isArrowpointAllowedCpdag(c, a, knowledge, graph) &&
     ...
     */
    private static boolean isArrowpointAllowedCpdag(Node from, Node to,
                                                      IKnowledge knowledge, Graph graph) {
