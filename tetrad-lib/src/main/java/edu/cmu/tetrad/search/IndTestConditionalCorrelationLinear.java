 ...
 */
public final class IndTestConditionalCorrelationLinear implements IndependenceTest, ScoreForFact {

    /**
     * The instance of CCI that is wrapped.
     */
    private final ConditionalCorrelationLinear cci;
     ...
     */
    public IndTestConditionalCorrelationLinear(DataSet dataSet, double alpha) {
        ...
        this.cci = new ConditionalCorrelationLinear(dataSet, alpha);
        this.alpha = alpha;
...
//        }
    ...
    public void setKernel(ConditionalCorrelationLinear.Kernel kernel) {
