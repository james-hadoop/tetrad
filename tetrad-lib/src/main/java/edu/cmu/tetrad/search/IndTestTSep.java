 ...
 */
public class IndTestTSep implements IndependenceTest {
    ...
    public IndTestTSep(Graph graph) {
        this(graph, false);
    }
     ...
     */
    public IndTestTSep(Graph graph, boolean keepLatents) {
        if (graph == null) {
