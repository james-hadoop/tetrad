 ...
 */
public class LinearGaussianBicScore implements Score {
     ...
     */
    public LinearGaussianBicScore(ICovarianceMatrix covariances) {
        if (covariances == null) {
     ...
     * Constructs the score using a covariance matrix.
     */
    public LinearGaussianBicScore(DataSet dataSet) {
        if (dataSet == null) {
            throw new NullPointerException();
        }
