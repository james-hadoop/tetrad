 ...
 */
public class StandardizedLinearSemIm implements Simulator, TetradSerializable {
...
//    private Map<Node, Double> errorVariances;
     ...
     */
    public StandardizedLinearSemIm(LinearSemIm im, Parameters parameters) {
     ...
     */
    public static StandardizedLinearSemIm serializableInstance() {
        return new StandardizedLinearSemIm(LinearSemIm.serializableInstance(), new Parameters());
    }
     ...
     */
    public StandardizedLinearSemIm(LinearSemIm im, Initialization initialization, Parameters parameters) {
        this.linearSemPm = new LinearSemPm(im.getSemPm());
        this.semGraph = new SemGraph(linearSemPm.getGraph());
...
//            throw new IllegalArgumentException("Not a directed edge in this model: " + edge);
    ...
    public List<Node> getVariableNodes() {
        return linearSemPm.getVariableNodes();
    }
     ...
     */
    public double[] means() {
        return new double[linearSemPm.getVariableNodes().size()];
    }
    ...
    public LinearSemPm getSemPm() {
        return new LinearSemPm(linearSemPm);
    }
    ...
    private boolean paramInBounds(Edge edge, double newValue) {
        ...
        for (Node node : linearSemPm.getVariableNodes()) {
