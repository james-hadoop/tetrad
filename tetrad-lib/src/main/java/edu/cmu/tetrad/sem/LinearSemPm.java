 ...
 */
public final class LinearSemPm implements PM, TetradSerializable {
     ...
     */
    public LinearSemPm(Graph graph) {
     ...
     */
    public LinearSemPm(SemGraph graph) {
        if (graph == null) {
     ...
     * Copy constructor.
     */
    public LinearSemPm(LinearSemPm linearSemPm) {
        this.graph = linearSemPm.graph;
        this.nodes = new LinkedList<>(linearSemPm.nodes);
        this.parameters = new LinkedList<>(linearSemPm.parameters);
        this.variableNodes = new LinkedList<>(linearSemPm.variableNodes);
        this.paramComparisons = new HashMap<>(
                linearSemPm.paramComparisons);
        this.tIndex = linearSemPm.tIndex;
        this.bIndex = linearSemPm.bIndex;
    }

    /**
     * Generates a simple exemplar of this class to test serialization.
     */
    public static LinearSemPm serializableInstance() {
        return new LinearSemPm(Dag.serializableInstance());
    }
